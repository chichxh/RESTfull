        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneAlt = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaIndex = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Directions_Conferences_ConferenceId",
                        column: x => x.ConferenceId,
                        principalTable: "Conferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Directions_Venues_VenueId",
                        column: x => x.VenueId,
                        principalTable: "Venues",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_Directions_DirectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Directions_ConferenceId",
                table: "Directions",
                column: "ConferenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Directions_VenueId",
                table: "Directions",
                column: "VenueId");

            migrationBuilder.CreateIndex(
                name: "IX_Roles_AreaIndex_AreaType",
                table: "Roles",
                columns: new[] { "AreaIndex", "AreaType" },
                unique: true);
